    ...
    ld = LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                default_value="/asv4/left_cam/image_rect_color/compressed",
                description="Front cam topic",
            ),
            DeclareLaunchArgument(
                "front_camera_info_topic",
                default_value="/asv4/left_cam/camera_info",
                description="Front cam camera info topic",
            ),
            DeclareLaunchArgument(
                "visualization_topic",
            ...
            DeclareLaunchArgument("map_ned_frame", default_value="left_cam"),
            DeclareLaunchArgument(
                "base_link_frame", default_value="asv4/base_link"
            ),
            DeclareLaunchArgument("odom_ned_frame", default_value="left_cam"),
